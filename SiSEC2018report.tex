...
\begin{figure}[h]
  \begin{center}
     \includegraphics[width=0.8\linewidth]{results/pairwise.png}
     \vspace{-1cm}
  \end{center}
...
\begin{figure}
  \begin{center}
     \includegraphics[width=\linewidth]{results/trackwise_vocals.png}
     \includegraphics[width=\linewidth]{results/trackwise_accompaniment.png}
     \vspace{-1cm}
  \end{center}
